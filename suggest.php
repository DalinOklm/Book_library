...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($name == "" || $email == "" || $category == "" || $title == "") {
            $error_message = "Please fill in the required fields: Name, Email, Category and
            Title";
        }
      ...
      if(!isset($error_message)) {
           ...
           $mail = new PHPMailer;
            //Tell PHPMailer to use SMTP
                  ...
                  $mail->Username = "ojovilakazi@gmail.com";
                  //Password to use for SMTP authentication
                  $mail->Password = "kooqvgmsucybrakw";


                  //It's important not to use the submitter's address as the from address as it's forgery,
                  //which will cause your messages to fail SPF checks.
                  //Use an address in your own domain as the from address, put the submitter's address in a reply-to
                  $mail->setFrom('ojovilakazi@gmail.com', $name);
                  $mail->addReplyTo($email, $name);
                  $mail->addAddress('ojovilakazi@gmail.com', 'Dalin Nkulu');
                  $mail->Subject = 'Library suggestion ' . $name;
...
<div class="section page">
  <div class="wrapper">
    <h1>Suggest a Media Item</h1>
       ...
       echo "<p>Thanks for the email!
      i&rsquo;ll check out your suggestion
      shortly!</p>";
        } else  { 
          if (isset($error_message)) {
            echo '<p class="message">'.$error_message.'</p>';
          }else {
            echo ' <p>if you think there is something i&rsquo; missing, let me know! Complete the form to send me an email. </p>';
          }
          ?>
